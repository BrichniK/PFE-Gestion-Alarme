    ...
    implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Output() readonly asideOpenedChanged: EventEmitter<boolean> =
        new EventEmitter<boolean>();
    @Output()
    ...
    @HostBinding('class') get classList(): any {
        ...
        return {
            ...
            'fuse-vertical-navigation-aside-opened': !!this.activeAsideItemId,
    ...
    openAside(item: FuseNavigationItem): void {
        ...
        // Emit aside open state
        this.asideOpenedChanged.next(true);
    ...
    closeAside(): void {
        ...
        // Emit aside open state
        this.asideOpenedChanged.next(false);
